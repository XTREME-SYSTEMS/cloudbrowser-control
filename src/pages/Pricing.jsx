...
const plans = [
  {
    ...
    features: {
      infrastructure: [
        { label: "Concurrent browsers", value: "3" },
        { label: "Browser hours", value: "1" },
        { label: "Agent runs", value: "3" },
        { label: "Search calls", value: "1,000" },
        { label: "Fetch calls", value: "1,000" },
        { label: "Max session duration", value: "15 min" },
      ],
      capabilities: [
        { label: "Data retention", value: "7 days" },
        { label: "Model tokens", value: "$5 included" },
        { label: "Runtime", value: "Included" },
        { label: "Captcha solving", value: false },
        { label: "Stealth mode", value: false },
        { label: "Sandbox", value: "1 sandbox" },
      ],
    },
  },
  {
