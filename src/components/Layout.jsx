...
import { Monitor, Briefcase, Calendar, Settings as SettingsIcon, LayoutDashboard, LogOut, Cloud, Menu, DollarSign, ScrollText, Code2, Trophy, Sparkles, Activity, AlertTriangle, CreditCard, Users, Plug, Folder, Bot, Wand2, Rocket, ShieldCheck, Globe, Shield, Moon, Sun, Command, FileSearch, FlaskConical, Eye, Train } from "lucide-react";
...
const navItems = [
  ...
  { to: "/capability-test-lab", label: "Test Lab", icon: FlaskConical },
  { to: "/vision-cortex", label: "Vision Cortex", icon: Eye },
  { to: "/railway-mirror", label: "Railway Mirror", icon: Train },
